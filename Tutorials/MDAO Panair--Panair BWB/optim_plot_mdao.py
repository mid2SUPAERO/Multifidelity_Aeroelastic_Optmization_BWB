...
plt.figure(1)
plt.plot(X, FB, color="green", linewidth=line_width)
plt.xlabel('Iterations', fontsize=font_size)
plt.ylabel('Objective function (FB)', fontsize=font_size)
...
plt.tight_layout()
plt.savefig('objective_D.pdf', bbox_inches='tight')

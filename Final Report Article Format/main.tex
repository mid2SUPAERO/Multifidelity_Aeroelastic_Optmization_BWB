...
\centering
\begin{tabular}{c}
\subfloat[Objective function]{\includegraphics[width=0.9\columnwidth]{images/comparison_objective_sellar.pdf}} \\
\subfloat[Lift Constraint]{\includegraphics[width = 0.9\columnwidth]{images/mdao_comparison_constraint_1.pdf}} \\
\subfloat[Stress Constraint]{\includegraphics[width = 0.9\columnwidth]{images/mdao_comparison_constraint_2.pdf}} 
\end{tabular}
...
\centering
\begin{tabular}{c}
\subfloat[Rosenbrock (worst) -McCormick (intermidiate)]{\includegraphics[width=0.9\columnwidth]{images/plot_beta_McCormick_Rosenbrock.pdf}} \\
\subfloat[Styblinski (best) - McCormick (intermidiate)]{\includegraphics[width = 0.9\columnwidth]{images/plot_beta_McCormick_Styblinski.pdf}} 
\end{tabular}
...
\centering
\begin{tabular}{c}
\subfloat[Objective function]{\includegraphics[width=0.4\textwidth]{images/comparison_objective_McCormick.pdf}} \\
\subfloat[Constraint 1]{\includegraphics[width = 0.4\textwidth]{images/McCormick_comparison_constraint_1.pdf}} \\
\subfloat[Constraint 2]{\includegraphics[width = 0.4\textwidth]{images/McCormick_comparison_constraint_2.pdf}} 
\end{tabular}
...
\centering
\begin{tabular}{c}
\subfloat[Objective function]{\includegraphics[width=0.4\textwidth]{images/comparison_objective_Brown.pdf}} \\
\subfloat[Constraint 1]{\includegraphics[width = 0.4\textwidth]{images/Brown_comparison_constraint_1.pdf}} \\
\subfloat[Constraint 2]{\includegraphics[width = 0.4\textwidth]{images/Brown_comparison_constraint_2.pdf}} 
\end{tabular}
...
\centering
\begin{tabular}{c}
\subfloat[Objective function]{\includegraphics[width=0.4\textwidth]{images/comparison_objective_Styblinski.pdf}} \\
\subfloat[Constraint 1]{\includegraphics[width = 0.4\textwidth]{images/Styblinski_comparison_constraint_1.pdf}} \\
\subfloat[Constraint 2]{\includegraphics[width = 0.4\textwidth]{images/Styblinski_comparison_constraint_2.pdf}} 
\end{tabular}
...
\centering
\begin{tabular}{c}
\subfloat[Objective function]{\includegraphics[width=0.4\textwidth]{images/comparison_objective_Rosenbrock.pdf}} \\
\subfloat[Constraint 1]{\includegraphics[width = 0.4\textwidth]{images/Rosenbrock_comparison_constraint_1.pdf}} \\
\subfloat[Constraint 2]{\includegraphics[width = 0.4\textwidth]{images/Rosenbrock_comparison_constraint_2.pdf}} 
\end{tabular}
...
\centering
\begin{tabular}{c}
\subfloat[Objective function]{\includegraphics[width=0.4\textwidth]{images/comparison_objective_Trigonometric.pdf}} \\
